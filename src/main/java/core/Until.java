...
public class Until
{
  ...
  public static ExpectedCondition<Boolean> newWindowOpens(final int numberOfCurrentWindowsOpened) {
    return new ExpectedCondition<Boolean>()
      {
        public Boolean apply(WebDriver d) { return Boolean.valueOf((d.getWindowHandles().size() >= numberOfCurrentWindowsOpened)); }
      };
  }
  ...
  public static ExpectedCondition<Boolean> cssPropertyChangesTo(String elementLocator, final String attribute, final String expectedProperty) {
    final By locator = ObjectLocators.getBySelector(elementLocator);
    log.info("Waiting until the element's " + locator + " css property " + attribute + " is changed to " + expectedProperty);
    ...
    return new ExpectedCondition<Boolean>() {
        ...
        public String toString() {
          return "Until the css attribute" + expectedProperty + " of element " + locator
            .toString() + "changes to " + expectedProperty;
        }
      };
  }
  ...
  public static ExpectedCondition<Boolean> urlContainsParam(final String expectedParam) {
    ...
    return new ExpectedCondition<Boolean>()
      {
        public Boolean apply(WebDriver d) { return Boolean.valueOf(d.getCurrentUrl().contains(expectedParam)); }



        
        public String toString() { return "Until the URL Contains the param : " + expectedParam; }
      };
  }
  ...
  public static ExpectedCondition<Boolean> titleContains(String expectedPageTitle) { return ExpectedConditions.titleContains(expectedPageTitle); }
  ...
  public static ExpectedCondition<Boolean> titleIs(String expectedPageTitle) { return ExpectedConditions.titleIs(expectedPageTitle); }
}
