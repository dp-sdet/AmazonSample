...
/**
 * Class to check the WebObject Repository
 */
...
public class WebObjectLocators extends ObjectLocators {
	static {
		...
		try {
			...
			webStream = new FileInputStream(EnvParameters.TEST_ROOT_DIR + File.separator + "ObjectRepo" + File.separator
					+ "PROP" + File.separator + "Web_ObjectRepository.properties");
