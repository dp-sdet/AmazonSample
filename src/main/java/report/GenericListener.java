...
//import com.pearson.common.framework.shared.alm.AlmUpdate;
//import com.pearson.common.framework.shared.datareader.ALMConfigReader;
  ...
  implements IInvokedMethodListener, ITestListener, ISuiteListener, IExecutionListener
{
  ...
  public static boolean almToggle;
  public static String almUpdateType;
  ...
  public void onFinish(ITestContext context) { removeIncorrectlyFailedTests(context); }
  ...
  public void onStart(ITestContext context) { System.setProperty("org.uncommons.reportng.escape-output", "false"); }
  ...
  public void onExecutionStart() {
    ...
    if (ARCHIVE_REPORT) {
      ...
      try {
        ...
        archivePath = System.getProperty("user.home") + File.separator + "Hawk_Test_Execution_Reports" + File.separator + TESTTYPE + " Results" + File.separator + strCurrYear + File.separator + theMonth(Integer.parseInt(strCurrMonth)) + File.separator;
