		...
		<HTML>
			...
			<BODY onload="drawPie();">
				<div id="container" class="centerIt">
					<table border="0" width="100%" height="45" class="heading">
						<tr height="21">
							...
							<td valign="center" align="center" width="80%">
								<p align="center">HAWK Automation Test Report</p>
							</td>
                            <td bgcolor="#ffffff" valign="center" align="center" width="10%">
                              <img src="img/HawkLogo.png"></img>
					...
					<TABLE bordercolorlight="#C0C0C0" bordercolordark="#00000"
					...
					<div id="footer"
						style="clear:both;text-align:center;background-color:white;font-size:11px;font-family:Palatino;"> 
